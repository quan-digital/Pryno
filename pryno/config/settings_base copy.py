...
# Mail & Telegram
#####################################################
# this section is to configure your email and telegram settings if you want to send message to alert you of anything
#just insert your credentials for mail as the example below
